...
|:--- | :--- |:--- |
| ad-clicks.csv |	A line is added to this file when a player clicks on an advertisement in the Flamingo app. |	timestamp: when the click occurred. | txId: a unique id (within ad-clicks.log) for the click <br/>userSessionid: the id of the user session for the user who made the click <br/>teamid: the current team id of the user who made the click
